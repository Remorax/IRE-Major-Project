...
def generate_final_ontology(name):
    ...
    # nodes = result.fetchall()
    # print (nodes)
    # print("/home/harish/Documents/onto/Ontology/OntologyDeterminer/Ontology-Determiner/SSAD22/src/onto_app/data/final/" + name + '.owl')
    # thefile=open("/home/harish/Documents/onto/Ontology/OntologyDeterminer/Ontology-Determiner/SSAD22/src/onto_app/data/final/" + name + '.owl',"r")
    # #print(thefile.readlines())
    # # for line in thefile.readlines():
    # #     print(line)
    # outputfile=open("/home/harish/Documents/onto/Ontology/OntologyDeterminer/Ontology-Determiner/SSAD22/src/onto_app/data/final/pizzafinal.owl","w+")
    ...
    #         if not accepted([d['approved'] for d in decisions]):
    #             print("XYZ",n['name'])
    #             nodes = doc.getElementsByTagName(n['name'])
